    ...
    IUnitOfWork unitOfWork) : ISocialService
{
    ...
    public string GoogleMobileLogin()
    {
        ...
        return $"https://accounts.google.com/o/oauth2/v2/auth?client_id={_settings.Google.ClientId}&redirect_uri={redirectUri}&response_type=code&scope={scope}&access_type=offline";
    }
    ...
    public string LinkedInMobileLogin()
    {
        ...
        return $"https://www.linkedin.com/oauth/v2/authorization?client_id={_settings.LinkedIn.ClientId}&redirect_uri={redirectUri}&response_type=code&scope={scope}";
    }
    ...
    private async Task<string> ProcessAccountAndGenerateCallbackUriAsync(Account account, CancellationToken cancellationToken)
    {
