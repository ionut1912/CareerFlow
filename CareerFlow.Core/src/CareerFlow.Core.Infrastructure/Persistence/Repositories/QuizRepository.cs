    ...
    : GenericRepository<QuizQuestion>(quizQuestions), IQuizRepository
{
    ...
    public async Task AddRangeAsync(List<QuizQuestion> quizQuestions, CancellationToken cancellationToken) => await _quizQuestions.AddRangeAsync(quizQuestions, cancellationToken);
}
