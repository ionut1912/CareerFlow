...
public class UpdateUserProfileCommandValidatorTests
{
    ...
    {
        //Arrange
        var command = new UpdateUserProfileCommand(Guid.NewGuid(), "Visual",  ["Student", "JobSearcher", "HobbyLearner","test"], "test");
    ...
    {
        //Arrange
        var command = new UpdateUserProfileCommand(Guid.NewGuid(), "Visual", ["Student"], "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
